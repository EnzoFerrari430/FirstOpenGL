...
int main()
{
    ...
    Shader shader("8.1.g_buffer.vs", "8.1.g_buffer.fs");
    //Shader splitWindowShader("8.1.split.vs", "8.1.split.fs");
    Shader shaderLightingPass("8.1.deferred_shading.vs", "8.1.deferred_shading.fs");
    Shader shaderLightBox("8.1.deferred_light.vs", "8.1.deferred_light.fs");
