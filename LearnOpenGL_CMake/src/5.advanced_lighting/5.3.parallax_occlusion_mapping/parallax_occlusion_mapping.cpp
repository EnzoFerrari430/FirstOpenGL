...
int main()
{
    ...
    Shader shader("5.3.parallax_occlusion_mapping.vs", "5.3.parallax_occlusion_mapping.fs");
    Shader normalShader("5.3.parallax_occlusion_mapping.vs", "5.3.normal_mapping.fs");
