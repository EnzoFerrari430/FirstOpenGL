...
int main()
{
	...
	// -------------------------
	Shader ourShader("res/shader/vertex.shader", "res/shader/fragment.shader");
	...
	glm::vec3 pointLightPosition(-4.0f, 2.0f, -12.0f);
	...
	while (!glfwWindowShouldClose(window))
	{
...

		{
			...
			lightModel = glm::scale(lightModel, glm::vec3(0.6f));
